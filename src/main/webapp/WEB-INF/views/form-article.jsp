...
<div class="container">
    <div class="bs-callout centered">
        <form:form  method="post" modelAttribute="article">
            ...
            <div class="form-group">
                <label for="author"><h4>Autor</h4></label>
                <form:select path="author.id" items="${authors}" itemLabel="fullName" itemValue="id" class="form-control" id="author"/>
            </div>
            <form:errors path="author" cssClass="error" element="div"/>
            <div class="form-group">
                <label for="categories"><h4>Kategorie</h4></label>
                <form:select path="categories" multiple="true" items="${categories}" itemLabel="name" itemValue="id" class="form-control" id="categories"/>
            </div>
