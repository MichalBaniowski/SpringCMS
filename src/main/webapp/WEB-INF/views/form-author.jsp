    ...
    <div class="bs-callout centered">
        <form:form  method="post" modelAttribute="author">
            <div class="form-group">
                <label for="firstName"><h4>Imię</h4></label>
                <form:input path="firstName" class="form-control" id="firstName" placeholder="podaj imię autora"/>
            </div>
            <form:errors path="firstName" cssClass="error" element="div"/>
            <div class="form-group">
                <label for="lastName"><h4>Nazwisko</h4></label>
                <form:input path="lastName" class="form-control" id="lastName" placeholder="podaj nazwisko autora"/>
            </div>
